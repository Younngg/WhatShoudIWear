...
const Filter: React.FC<FilterProps> = ({ dates, setPosts }) => {
  ...
  const onChangeFilter = (e: { target: { value: any; id: any } }) => {
    switch (e.target.id) {
      ...
      case 'cityFilter':
        ...
        break;
      case 'tempFilter':
        setFilter((cur: FilterState) => ({ ...cur, temp: e.target.value }));
        break;
      default:
        return;
    }
